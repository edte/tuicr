...
mod remote_comments_snapshot_tests {
    ...
    #[test]
    fn should_hide_file_list_message_in_minimal_ui() {
        let mut app = make_pr_app();
        app.minimal_ui = true;
        app.show_file_list = false;
        ...
        assert!(
            ...
            "file-list message leaked into minimal UI:\n{body}"
        );
    ...
    #[test]
    fn should_keep_file_list_message_outside_minimal_ui() {
        let mut app = make_pr_app();
        app.minimal_ui = false;
        app.show_file_list = false;
